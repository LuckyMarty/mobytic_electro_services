    ...
    {block name='page_content'}
      {block name='hook_home'}
        ...
        <div class="container" id="mobytic_welcome_home">
          <div class="row">
            <div class="col-sm-12 featured-products">
              <div>
                <img src="https://i.postimg.cc/SsnjsJhc/Group-23.png">
            ...
            <div class="col-sm-4">
              <img class="logo img-fluid" src="https://i.postimg.cc/4dWTqTFy/LOGO-ELECTRO-SERVICES-HD.png" alt="Mobytic"
