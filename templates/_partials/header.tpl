  ...
  <div class="header-top">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-6 col-sm-3 hidden-sm-down" id="_desktop_logo">
        ...
        <div class="col-xs-6 col-sm-3 hidden-sm-down" id="mobytic-header-right-nav">
          {hook h='displayNav2'} 
          {include file="./_mobytic/ht_ttc.tpl"}
        </div>
